...
namespace API.Tests
{
    public class SanitizeWordsControllerTests
    {
        ...
        public SanitizeWordsControllerTests()
        {
            ...
            _sanitizeWordsController = new SanitizeWordsController(_mockSensitiveWordsRepository.Object, _mockCache.Object, _logger);
        ...
        //zeWordsController(_mockSensitiveWordsRepository.Object, _mockCache.Object, _logger);
        [Fact]
        public async Task Sanitize_ReturnsOkResult_WithCaseInsensitiveSanitization()
        {
            // Arrange
            var input = "Pran test string SELECT * FROM when I ADD things here";
            var words = new List<string> { "seleCt * from", "aDd" };
